...
public class Usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("no estoy de acuerdo");
        ...
        jRadioButton2.setText("estoy de acuerdo");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jRadioButton1.isSelected() == true) {
            v.addNegativo();
            System.out.println(v.getNegativo());
            jButton2.setEnabled(false);
            jLabel3.setText("Has votado Negativo.");
         
        } else if (jRadioButton2.isSelected() == true) {
            v.addPositivo();
            System.out.println(v.getPositivo());
            jButton2.setEnabled(false);
            jLabel3.setText("Has votado positivo.");

        } else {
            jLabel3.setText("Marca una opcion.");
